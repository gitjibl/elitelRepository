(function ($) {
    if ($.fn.pagination) {
        ...
        $.fn.pagination.defaults.displayMsg = '当前页显示从第 {from} 条到第 {to} 条 / 共 {total} 条';
    }
    if ($.fn.datagrid) {
        ...
        if ($.fn.datagrid.defaults.operators) {
            ...
            $.fn.datagrid.defaults.operators.beginwith.text = '以此开始';
            $.fn.datagrid.defaults.operators.endwith.text = '以此结束';
    ...
    $.map(['validatebox', 'textbox', 'filebox', 'searchbox',
        'combo', 'combobox', 'combogrid', 'combotree', 'datebox', 'datetimebox', 'numberbox',
    ...
    if ($.fn.validatebox) {
        ...
        $.fn.validatebox.defaults.rules.remote.message = '请修正输入项内容';
    }
    if ($.fn.calendar) {
