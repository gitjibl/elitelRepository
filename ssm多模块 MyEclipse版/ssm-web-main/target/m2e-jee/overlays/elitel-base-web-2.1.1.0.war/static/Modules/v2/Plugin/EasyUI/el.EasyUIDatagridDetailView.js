        ...
        subgrid: function (jq, conf) {
            return jq.each(function () {
                ...
                function createGrid(target, conf, prow) {
                    var queryParams = $.extend({}, conf.options.queryParams || {});
                    queryParams[conf.options.foreignField] = prow ? prow[conf.options.foreignField] : undefined;
                    var detailFormatter = conf.options.detailFormatter;
                    var onExpandRow = conf.options.onExpandRow;
                    var onCollapseRow = conf.options.onCollapseRow;
                    var onResize = conf.options.onResize;
                    var onResizeColumn = conf.options.onResizeColumn;
                    var onLoadSuccess = conf.options.onLoadSuccess;
                    $(target).datagrid($.extend({}, conf.options, {
                        subgrid: conf.subgrid,
                        view: (conf.subgrid ? detailview : conf.options.view),
                        queryParams: queryParams,
                        detailFormatter: function (index, row) {
                            if (typeof detailFormatter == "function")
                                detailFormatter.call(this, index, row);
                            else
                                return '<div><table class="datagrid-subgrid"></table></div>';
                        },
                        onExpandRow: function (index, row) {
                            ...
                            if (typeof onExpandRow == "function")
                                onExpandRow.call(this, index, row);
                        },
                        onCollapseRow: function (index, row) {
                            setHeight(this, index);
                            if (typeof onCollapseRow == "function")
                                onCollapseRow.call(this, index, row);
                        },
                        onResize: function () {
                            var dg = $(this).children('div.datagrid-view').children('table')
                            setParentHeight(this);
                        ...
                        onResizeColumn: function (field, width) {
                            ...
                            if (typeof onResizeColumn == "function")
                                onResizeColumn.call(this, field, width);
                        },
                        onLoadSuccess: function (data) {
                            setParentHeight(this);
                    ...
                    if (typeof prow != 'undefined') {
                        var data = prow;
                        if (typeof conf.options.dataField != 'undefined')
                            data = prow[conf.options.dataField];
